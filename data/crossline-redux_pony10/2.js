...
lines['crossline-redux_pony10']['2'] = [
    ...
    },
    {
        ...
        joints: [
            { x: 1.5, name: '132', limit: 0 },
            { x: 1889, name: '132', limit: 0 },
        ],
        signals: [
        ],
        mks: [
    ...
    },
    {
        ...
        joints: [
            { x: 1, name: '164', limit: 0 },
            { x: 1 + 75, name: '162', limit: 60 },
            { x: 1 + 75 + 75, name: '160', limit: 80 },
            { x: 1 + 75 + 75 + 75, name: '160а', limit: 80 },
            { x: 1 + 75 + 75 + 75 + 262.5, name: '160б', limit: 80 },
            ...
            { x: 1913 + 63 - 75 - 62.5 - 87.5 - 112.5 - 112.5 - 25, name: '156б', limit: 80, later: { 80: -1 } },
            { x: 1913 + 63 - 75 - 62.5 - 87.5 - 112.5 - 50, name: '156в', limit: 80 },
        ...
        signals: [
            { joint: '162', name: '160м', lenses: 'YGR', guard: 35, autostop: 3, g: '160б', gmod: { FLeft: true, OW: '[-7 0 -10]' } },
            { joint: '160б', name: '158м', lenses: 'YGR', guard: 80, autostop: 3, g: '158а' },
            ...
            { joint: '154', name: 'РЕ-148', lenses: 'YYG-Rw', guard: 70, autostop: 1, left: true, y: '148', g: 'NEXT_yg' },
            { joint: '152', name: '146', lenses: 'YY-GR', guard: 70, autostop: 1, shift: 14, yg: '146', gmod: { Double: true, DoubleL: true } },
        ],
        mks: [
    ...
    },
    {
        ...
        joints: [
            ...
            { x: 1588 - 75 - 87.5 - 87.5 - 100 - 125 - 462.5, name: '142', limit: 80 },
            { x: 1588 - 75 - 87.5 - 87.5 - 100 - 125 - 200, name: '140', limit: 80 },
            { x: 1588 - 75 - 87.5 - 87.5 - 100 - 125, name: '140а', limit: 80 },
            { x: 1588 - 75 - 87.5 - 87.5 - 100, name: '140б', limit: 80 },
            { x: 1588 - 75 - 87.5 - 87.5, name: '138', limit: 80 },
            { x: 1588 - 75 - 87.5, name: '136', limit: 80 },
            { x: 1588 - 58, name: '134', limit: 70 },
            { x: 1588, name: '132', limit: 60 },
        ...
        signals: [
            ...
            { joint: '144а', name: '142', lenses: 'YY-GR', guard: 80, autostop: 3, y: '142', g: 'NEXT_y' },
            { joint: '142', name: '140', lenses: 'YY-GR', guard: 80, autostop: 1, y: '140б', yg: 'NEXT_y', g: 'NEXT_yg' },
            { joint: '140а', name: '138м', lenses: 'YY-GR', guard: 80, autostop: 3, left: true, y: '138', yg: 'NEXT_y', g: 'NEXT_yg' },
            { joint: '140б', name: 'ОК-136', lenses: 'YYG-Rw', guard: 70, autostop: 3, left: true, y: '136', yg: 'NEXT_y', g: 'NEXT_yg' },
            { joint: '138', name: 'ОК-134', lenses: 'YYG-Rw', guard: 70, autostop: 1, left: true, y: '134', yg: 'NEXT_y', g: 'NEXT_g' },
            { joint: '136', name: 'ОК-132', lenses: 'YYG-Rw', guard: 70, autostop: 1, y: '132', g: 'NEXT_yg' },
