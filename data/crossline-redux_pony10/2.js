...
lines['crossline-redux_pony10']['2'] = [
    ...
    },
    {
        ...
        joints: [
            ...
            { x: 1917 + 1.5 + 25 + 12.5 - 62.5, name: '6278', limit: 60, point: true, gmod: {Kanava: true} },
            { x: 1917 + 1.5 + 25 + 12.5, name: '6280', limit: 60, point: true, gmod: {Kanava: true} },
    ...
    },
    {
        ...
        signals: [
            ...
            { joint: '156б', name: 'РЕ-154', lenses: 'YYG-Rw', guard: 80, autostop: 3, y: '154', left: true, yg: 'NEXT_y', g: 'NEXT_yg' },
    ...
    },
    {
        ...
        joints: [
            ...
            { x: 1588, name: '132', limit: 60, gmod: { Kanava: true, Routes: [{Switches: "OK2+"},{Switches: "OK2-",ARSCodes: "004", NextSignal: "*"}] } },
            { x: 1588 + 75, name: '130', limit: 40, later: { 40: -1 } },
            { x: 1588 + 75 + 50, name: '128', limit: 0 },
            { x: 1588 + 75 + 50 + 100, name: '128а', limit: 0 },
        ],
        signals: [
            { joint: '146', name: '144м', lenses: 'YGR', guard: 35, autostop: 3, g: '144а' },
    ...
    },
    {
        ...
        joints: [
            ...
            { x: 1843 -6 - 37.5, name: '1110', limit: 70, gmod:{Routes:[{ARSCodes:"06"}], Kanava: true} },
